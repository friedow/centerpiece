...
impl Plugin for WindowsPlugin {
    fn new(
        ...
        let entries_result = Self::all_entries(&mut sway);
...
impl PluginProcess for WindowsPlugin {}
...
trait Plugin {
    fn new(plugin_channel_out: iced::futures::channel::mpsc::Sender<crate::Message>,
        app_channel_out: iced::futures::channel::mpsc::Sender<crate::model::PluginRequest>,
        plugin_channel_in: iced::futures::channel::mpsc::Receiver<crate::model::PluginRequest>) -> Self;
    fn all_entries(sway: &mut swayipc::Connection) -> anyhow::Result<Vec<crate::model::Entry>>;
}

trait PluginProcess: Plugin {
    fn spawn() -> iced::Subscription<crate::Message> {
        return iced::subscription::channel(
            ...
            |plugin_channel_out| async {
                ...
                let mut plugin = Plugin::new(plugin_channel_out, app_channel_out, plugin_channel_in);
                plugin.main().await
            },
        );
    }
